...
export default function TurnActions() {
	...
	let turnIndicator;
	if (yourTurn) {
		turnIndicator = <div className={Styles.yourTurnDiv}>Your turn!</div>;
	} else {
...
function RollDie() {
	...
	return (
		<li><button className={Styles.buttonsStyle} onClick={roll}>Roll die</button></li>
	);
}
...
function MoveThroughPassage() {
	...
	return (
		<li>
			<button className={Styles.buttonsStyle} onClick={move}>
...
function MakeSuggestion() {
	...
	if (!expanded) {
		...
		return <li><button className={Styles.buttonsStyle} onClick={expand}>Make suggestion</button></li>;
	}
...
function DisproveSuggestion() {
	...
	for (const card of gameState.suggestion) {
		if (yourCards.includes(card)) {
			...
			disproveButtons.push(
				<li key={card}>
					<button className={Styles.buttonsStyle} onClick={handler(card)}>Disprove with {card}</button>
				</li>
			);
		}
	}
	...
	if (!haveDisprovingCard) {
		disproveButtons.push(
			<li key="cannot">
				<button className={Styles.buttonsStyle} onClick={handler(null)}>I cannot dispove!</button>
			</li>
		);
	}
...
function MakeAccusation() {
	...
	if (!expanded) {
		...
		return <li><button className={Styles.buttonsStyle} onClick={expand}>Make accusation</button></li>;
	}
...
function EndTurn() {
	...
	return (
		<li><button className={Styles.buttonsStyle} onClick={end}>End turn</button></li>
	);
}
